    ...
    <div className="admin-artwork">
      <header className="admin-header">
        ...
        <p className="muted">
          ...
          make it a factor. <strong>Promos are not listed here:</strong> they aren't on the site at
          all, because what a promo is worth depends mostly on how hard it was to obtain, and that
          is nowhere in the data. Saved in this browser only; export the file to keep it somewhere
          durable.
        </p>
